...
export class AppBase {
  ...
  onLoad(options) {
    ...
    if (AppBase.InstInfo != null) {
      this.Base.setMyData({
        InstInfo: AppBase.InstInfo
      });
    } else {
      instapi.info({}, (InstInfo) => {
        console.log(InstInfo, "wodeInstInfo")
        ...
        memberapi.getuserinfo({
          ...
          wx.getUserInfo({
            success: userres => {
              ...
              memberapi.update(userres.userInfo);
              that.Base.setMyData({
                MemberInfo: userres.userInfo
              });
            },
            fail: userresfail => {
              console.log("userresfail", userresfail);
              that.Base.setMyData({
                MemberInfo: null
              });
            }
